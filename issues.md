...
- [ ] M1-04: Staging deploy setup (frontend + api + managed Postgres/Redis) and healthcheck (type: chore, label: infra-deploy) — rolled back staging prep files; pending re-plan
